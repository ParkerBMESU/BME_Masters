...
# Basic settings
# if len(sys.argv)==5:
folder = "Irshaad"  # str(sys.argv[1])            # e.g. Timelapse
filename = "vibimages"  # str(sys.argv[2])          # e.g. im_exp1
interval = 10  # int(sys.argv[3])     # wait time in seconds e.g. 1800
steps = 100  # int(sys.argv[4])        # number of images   e.g 200
# else:
...
camera.shutter_speed = 2000000  # exposure time in microsecs
camera.exposure_mode = 'night'  # 'fixedfps'
camera.awb_gains = [0, 8]
